...
const KeyboardAwareScrollable = ({
  ...
  const commonProps = {
    ...
    keyboardShouldPersistTaps: (childAttrs['keyboardShouldPersistTaps'] ?? 'handled') as 'always' | 'never' | 'handled',
    ...
    ...(Platform.OS === 'ios'
      ? { contentInsetAdjustmentBehavior: (childAttrs['contentInsetAdjustmentBehavior'] ?? contentInsetBehaviorIOS) as 'automatic' | 'scrollableAxes' | 'never' | 'always' }
      : {}),
  };
